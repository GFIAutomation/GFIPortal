...
GO
IF OBJECT_ID(N'[dbo].[FK_Report_BatteryTest]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Report] DROP CONSTRAINT [FK_Report_BatteryTest];
GO
IF OBJECT_ID(N'[dbo].[FK_Report_Machine]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Report] DROP CONSTRAINT [FK_Report_Machine];
GO
